...
class ver_puesto extends Component {
  ...
  cambiarEstadoCategoria(estado){
    ...
    fetch(Server+'configuracion/ticket.php?accion=estado_cat', {
                    method: 'POST',
                    headers: {
                ...
                .catch((error) => {
                  message.error("Error al actualizar categoría."+error);
                  this.setState({cargando:false})
                });
  ...
  cambiarEstadoSubCat(estado){
    ...
    fetch(Server+'configuracion/ticket.php?accion=estado_sub_cat', {
                    method: 'POST',
                    headers: {
                      'Accept': 'application/json',
                    },
                ...
                .catch((error) => {
                  message.error("Error al actualizar sub categoría."+error);
                  this.setState({cargando:false})
                });
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if(!this.state.sub_categoria_edicion){
          ...
          fetch(Server+'configuracion/ticket.php?accion=nueva_sub_categoria', {
                          method: 'POST',
                          headers: {
                            'Accept': 'application/json',
                          },
                      ...
                      .then((responseJson) => {
                          ...
                          if(responseJson !== 'error'){
                            ...
                            this.setState({sub_seleccionada:responseJson})
          ...
          fetch(Server+'configuracion/ticket.php?accion=edit_sub_categoria', {
                          method: 'POST',
                          headers: {
                            'Accept': 'application/json',
                          },
  ...
  getSubCategorias(){
    ...
    fetch(Server+'configuracion/ticket.php?accion=get_sub_categorias', {
                    method: 'POST',
                    headers: {
                      'Accept': 'application/json',
                    },
                ...
                .catch((error) => {
                  message.error("Error al cargar Sub Categorías."+error);
                  this.setState({cargando:false})
                });
  ...
  //  alert(this.props.id_categoria?this.props.id_categoria:0)

    fetch(Server+'configuracion/ticket.php?accion=get_tickets', {
                    method: 'POST',
                    headers: {
                      'Accept': 'application/json',
                    },
                ...
                .catch((error) => {
                  message.error("Error al cargar Tickets."+error);
                  this.setState({cargando:false})
                });
  ...
  //  alert(this.props.id_categoria?this.props.id_categoria:0)
    ...
    fetch(Server+'configuracion/ticket.php?accion=get_ticket', {
                    method: 'POST',
                    headers: {
                      'Accept': 'application/json',
                    },
                ...
                .then((responseJson) => {
                    ...
                    if(responseJson !== 'error'){
                      ...
                      var resultado = {
                        id_ticket:responseJson.id_ticket,
                        nombre_ticket:responseJson.nombre_ticket,
                        descripcion:responseJson.descripcion,
                        id_sub_categoria:responseJson.id_sub_categoria,
                        tiempo_estimado:responseJson.tiempo_estimado,
                        prioridad_recomendada:responseJson.prioridad_recomendada,
                        estado:responseJson.estado,
                        creacion:responseJson.creacion,
                        procedimiento:responseJson.procedimiento,
                        sub_categoria:JSON.parse(responseJson.sub_categoria),
                        categoria:JSON.parse(responseJson.categoria),
                      }
                ...
                .catch((error) => {
                  message.error("Error al cargar Ticket."+error);
                  this.setState({cargando:false})
                });
  ...
  cambiarEstadoTicket(estado){
    ...
    //alert(this.state.ticket_edicion.id_ticket)
    fetch(Server+'configuracion/ticket.php?accion=estado', {
                    method: 'POST',
                    headers: {
                      'Accept': 'application/json',
                    },
